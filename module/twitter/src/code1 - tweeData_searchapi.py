...
for tweet in tweepy.Cursor(api.search,q='RCOM OR RELCAPITAL OR "RELIANCE JIO" OR "Reliance Industries" OR RELINFRA OR RPOWER OR RELBANK OR RDEL OR RELGOLD OR RELMEDIA', lang="en", since='2017-04-21',until='2017-04-22').items():
